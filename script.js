...
let wardrobeSVG = document.querySelector("#wardrobe");
...
wardrobeSVG.addEventListener("touchstart", (e) => {
    touchOUT = false;
    if (e.touches.length === 1)
        dialogBox(e.touches[0].clientX, e.touches[0].clientY, "wardrobe omg !?");
