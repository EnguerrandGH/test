...
let desktopSVG = document.querySelector("#desktop");
...
desktopSVG.addEventListener("touchstart", (e) => {
    touchOUT = false;
    if (e.touches.length === 1)
        dialogBox(e.touches[0].clientX, e.touches[0].clientY, "desktop omg !?");
...
function dialogBox(x, y, text) {
    ...
    newDiv.style.transform = `translate(${ posX / window.innerWidth * 100 }vw, ${ posY / window.innerHeight * 100 }vh)`;
